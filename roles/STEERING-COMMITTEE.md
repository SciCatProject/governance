...
Committee or SC.
Members from contributing organizations may be added once approved by the Steering Committee as described in the Governance document.
...
- _please comment or reach out to the Project Leaders with any feedback or comment_
 ...
 | NAME              | GitHub Handle | Organization | Status      | Notes               |
 | ----------------- | ------------- | ------------ | ----------- | ------------------- |
 ...
 | Mirjam Lindberg   | ---           | MaxIV        | Preliminary |                     |
