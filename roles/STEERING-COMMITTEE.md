...
This document lists the members of the Organization's Steering
Committee or SC.
Members from supporting organizations and facilities may be added once approved by the Steering Committee as described in the Governance document.

By adding your name to this list you are agreeing to abide by all Organization polices, including the organizational charter document, the code of conduct, and the antitrust policy.  
...
| __NAME__ | __GitHub Handle__ | __Supporting Organization__ | __Status__ |
| --- | --- | --- | --- |
